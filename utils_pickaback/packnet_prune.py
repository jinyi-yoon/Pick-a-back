...
class SparsePruner(object):
    ...
    def gradually_prune(self, curr_prune_step):
        # print('...... [packnet prune] gradually prune')
    ...
    def one_shot_prune(self, one_shot_prune_perc):
        # print('...... [packnet prune] one shot prune')
    ...
    def calculate_sparsity(self):
        # print('...... [packnet prune] calculate sparsity')
        total_elem = 0
        zero_elem = 0
        for name, module in self.model.named_modules():
            if isinstance(module, nn.Conv2d) or isinstance(module, nn.Linear):
    ...
    def calculate_curr_task_ratio(self):
        # print('...... [packnet prune] calculate curr task ratio')
        total_elem = 0
        curr_task_elem = 0
        for name, module in self.model.named_modules():
            if isinstance(module, nn.Conv2d) or isinstance(module, nn.Linear):
    ...
    def calculate_zero_ratio(self):
        # print('...... [packnet prune] calculate zero ratio')
        total_elem = 0
        zero_elem = 0
        for name, module in self.model.named_modules():
            if isinstance(module, nn.Conv2d) or isinstance(module, nn.Linear):
    ...
    def do_weight_decay_and_make_grads_zero(self):
        # print('...... [packnet prune] do weight decay and make grads zero')
    ...
    def make_pruned_zero(self):
        # print('...... [packnet prune] make pruned zero')
    ...
    def apply_mask(self):
        # print('\...... [packnet prune] apply mask')
    ...
    def make_finetuning_mask(self):
        # print('...... [packnet prune] make finetuning mask')
