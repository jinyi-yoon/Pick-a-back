...
class VGG(nn.Module):
    ...
    def forward(self, x):
        # print('...... [VGG] forward starts')
        # print('... in VGG) features[0].weight[0][0][0] = ', end='')
        # print()
        # print(self.features[0].weight[0][0][0])
        x = self.features(x)
        # print()
        # print('... in VGG) after forward x[0][0] = ', end='')
        # print(x[0][0])
        # print('...... [VGG] forward features')
        x = self.classifier(x)
        # print('... in VGG) after classifier x[0][0] = ', end='')
        # print(x[0][0])
        # print('...... [VGG] forward ends')
        return x
